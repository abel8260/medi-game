...
<!DOCTYPE html>
  ...
  <!--body-->
    ...
    <body style="background-image:url('../../img/background.png');background-size:100%; ">
        ...
        <!--img-->
            <img class="solo w3-spin"  width='20%' height='20%' src='../../img/boss-5.png' style='left:40%; top:45%; position:absolute; '/>
          ...
          <script>
            ...
            function move1() {
              ...
              var width = 1;
              var id = setInterval(frame, 2160000);
            ...
            function move2() {
              ...
              var width = 1;
              var id = setInterval(frame, 6480000);
